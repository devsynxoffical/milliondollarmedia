      ...
      <div className="relative mx-auto max-w-[1240px] px-5 md:px-8">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <motion.div style={{ y: contentY, opacity: fade }}>
            <h1 className="font-futura text-[1.85rem] leading-[1.12] tracking-[-0.02em] text-white sm:text-4xl lg:text-[2.7rem]">
              <motion.span
                variants={fadeUp}
                initial="hidden"
                animate="show"
              ...
              <motion.span
                ...
                className="block"
              >
                Or We&apos;ll Continue Working For You At No Management Fee Until
                We Do.
              </motion.span>
            </h1>
            ...
            <motion.p
              ...
              animate="show"
              custom={0.55}
              className="mt-3 text-[11px] font-bold uppercase tracking-[0.22em] text-zinc-400"
            >
              Backed By A Written Agreement.
            </motion.p>
