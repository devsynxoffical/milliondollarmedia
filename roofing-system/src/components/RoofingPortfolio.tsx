...
function VideoTile({ video, index }: { video: (typeof ROOFING_VIDEOS)[number]; index: number }) {
  ...
  return (
    <Reveal delay={index * 0.08} className="h-full">
      <div className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/15 bg-[#0d0e14] shadow-2xl backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:border-[#ed1c24] hover:shadow-[0_25px_50px_-12px_rgba(237,28,36,0.5)]">
        ...
        <div className="relative aspect-[9/16] w-full overflow-hidden bg-zinc-950">
          ...
          <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border border-white/40 bg-[#ed1c24] text-white shadow-[0_0_40px_rgba(237,28,36,0.9)] backdrop-blur scale-90 group-hover:scale-100 transition-transform">
