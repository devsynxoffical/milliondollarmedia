    ...
    <section id="comparison" className="section-shell bg-white">
      <div className="mx-auto max-w-[1200px]">
        <Reveal className="mx-auto max-w-3xl text-center">
          <p className="eyebrow-accent">Why businesses choose us</p>
        ...
        <div className="mt-14 grid items-stretch gap-6 md:grid-cols-2">
          <Reveal className="h-full">
            <article className="flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-[var(--line)] bg-[var(--surface-2)]">
          ...
          <Reveal delay={150} className="h-full">
            <article className="relative flex h-full flex-col overflow-hidden rounded-[1.75rem] border-2 border-[var(--accent)] bg-white shadow-[0_24px_60px_-24px_rgba(237,28,36,0.35)] md:-translate-y-2">
              ...
              <ul className="flex-1 space-y-3 px-8 py-8 md:px-10">
                {system.map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-3 rounded-2xl bg-[var(--accent-soft)] px-4 py-3 text-sm font-semibold text-[var(--ink)]"
                  >
