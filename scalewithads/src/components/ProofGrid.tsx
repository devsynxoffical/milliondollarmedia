    ...
    <>
      <div className="mt-12 grid gap-6 lg:grid-cols-2">
        {files.map((file) => {
          ...
          return (
            <div key={file} className="card overflow-hidden p-2">
              <div
                className="relative w-full overflow-hidden rounded-lg bg-[var(--surface-2)] transition-[height] duration-500 ease-out"
                style={{ height }}
              >
                <Image
                  src={`/media/proof/${file}`}
                  alt="Campaign dashboard result"
                  fill
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 px-2 pb-2 pt-4">
                <div>
                  ...
                  <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--accent)]">
                    Live result
                  </p>
                </div>
