      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 inline-flex items-center gap-4 self-start rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] p-5">
              ...
              <div className="flex flex-col gap-0.5">
                <p className="display text-xl text-[var(--ink)]">
                  $50M+{" "}
                  <span className="text-[var(--accent)]">Meta spend</span>
                </p>
          ...
          <div className="relative">
            ...
            <div className="relative card overflow-hidden shadow-[0_24px_60px_-24px_rgba(16,24,40,0.3)]">
              ...
              <div className="flex items-center justify-between gap-4 border-t border-[var(--line)] px-5 py-4 md:px-6">
                ...
                <span className="chip hidden bg-[var(--accent-soft)] text-[var(--accent)] sm:inline">
                  Video proof
                </span>
              </div>
            </div>
            ...
            <div className="mt-5 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-black/15 text-black transition hover:scale-105 hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-white"
                >
