...
function mbo_fill_deal_columns( $column, $ID )
{
    ...
    elseif ( 'bumpProduct' == $column )
    {
        ...
        {
            echo '<div id="bump-product-'.$ID.'" data-bump-product-id="'.$pid.'" style="font-size:90%; color:red">' . esc_html__( "Product not found. Could it have been deleted?", 'molongui-bump-offer' ) . '</div>';
        }
