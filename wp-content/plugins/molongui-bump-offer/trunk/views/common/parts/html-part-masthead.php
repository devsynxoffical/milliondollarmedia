...
$molongui_logo = MOLONGUI_BUMP_OFFER_URL . 'assets/img/common/masthead_logo.png';
$logo = !empty( $args['logo'] ) ? $args['logo'] : $molongui_logo;
$link = !empty( $args['link'] ) ? $args['link'] : MOLONGUI_BUMP_OFFER_WEB;
    ...
    <div class="m-page-masthead__inside_container">
        <div class="m-page-masthead__logo-container">
            <a class="m-page-masthead__logo-link" href="<?php echo $args['link']; ?>">
                <img src="<?php echo $logo; ?>" alt="<?php echo MOLONGUI_BUMP_OFFER_TITLE; ?>" height="32">
            </a>
        </div>
        <?php if ( $btn ) : ?>
