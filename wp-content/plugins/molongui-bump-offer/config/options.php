...
if ( true )
{
    ...
    (
        'display' => true,
        'type'    => 'title',
        'label'   => __( "Personalize Molongui Order Bumps. Settings that make it yours.", 'molongui-bump-offer' ),
    );
    $options[] = array
    (
        'display' => true,
        ...
        'class'   => '',
        'id'      => 'deals',
        'label'   => __( "Order Bumps", 'molongui-bump-offer' ),
        'button'  => array(),
    );
    $options[] = array
    (
        ...
        'id'      => 'notice_edit_deal',
        'title'   => '',
        'desc'    => sprintf( __( "Order bumps can be managed from the %sOrder Bumps%s submenu item you will find under the %sWooCommerce%s admin menu. Go there and customize your deals to your needs with full live preview.", 'molongui-bump-offer' ), '<strong>', '</strong>', '<strong><span id="mbo-menu-item">', '</span></strong>' ),
        'help'    => '',
        'link'    => '',
    );
    $options[] = array
...
if ( true )
{
    ...
    (
        ...
        'title'   => '[molongui_deal]',
        'desc'    => sprintf( __( "Displays an order bump anywhere you want. Want to display your deal on the sidebar? Maybe on a product landing page? Make use of this easy to use shortcode and let your customers add the offered product to their Cart with just 1 click!", 'molongui-bump-offer' ), '<a href="https://www.molongui.com/docs/order-bump-for-woocommerce/shortcodes/" target="_blank">', '</a>' ),
