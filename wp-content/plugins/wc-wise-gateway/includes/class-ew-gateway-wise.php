                    ...
                    <table class="widefat wc_input_table sortable" cellspacing="0">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <a href="https://github.com/woocommerce/woocommerce/blob/release/9.1.0.10/plugins/woocommerce/i18n/countries.php#L17" target="_blank"><?php esc_html_e( 'Countries', 'wc-wise-gateway' ); ?></a> |
                                <a href="https://github.com/woocommerce/woocommerce/blob/release/9.1.0.10/plugins/woocommerce/i18n/continents.php#L16" target="_blank"><?php esc_html_e( 'Continents', 'wc-wise-gateway' ); ?></a> |
                                <a href="https://github.com/woocommerce/woocommerce/blob/release/9.1.0.10/plugins/woocommerce/includes/wc-core-functions.php#L665" target="_blank"><?php esc_html_e( 'Currencies', 'wc-wise-gateway' ); ?></a>
                               </th>
                                <th colspan="3">&nbsp;</th>
